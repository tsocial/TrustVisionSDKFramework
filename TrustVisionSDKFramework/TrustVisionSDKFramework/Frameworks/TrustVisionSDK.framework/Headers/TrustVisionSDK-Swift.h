...
@property (nonatomic) BOOL isSanityRequired;
@property (nonatomic) enum TVLivenessOption livenessMode;
- (nonnull instancetype)initWithCameraOption:(enum TVCameraOption)cameraOption isSoundEnable:(BOOL)isSoundEnable isSanityRequired:(BOOL)isSanityRequired livenessMode:(enum TVLivenessOption)livenessMode OBJC_DESIGNATED_INITIALIZER;
...
+ (void)initializeWithLocalizationFiles:(NSArray<TVLocalizationFile *> * _Nullable)localizationFiles languageCode:(NSString * _Nullable)languageCode isForced:(BOOL)isForced success:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(TVError * _Nonnull))failure;
+ (void)initializeWithAccessKeyId:(NSString * _Nonnull)accessKeyId accessKeySecret:(NSString * _Nonnull)accessKeySecret localizationFiles:(NSArray<TVLocalizationFile *> * _Nullable)localizationFiles languageCode:(NSString * _Nullable)languageCode isForced:(BOOL)isForced success:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(TVError * _Nonnull))failure;
