...
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id name:(NSString * _Nonnull)name orientation:(enum CardOrientation)orientation hasBackSide:(BOOL)hasBackSide OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithCardType:(TVCardType * _Nonnull)cardType isSoundEnable:(BOOL)isSoundEnable isReadBothSide:(BOOL)isReadBothSide cardSide:(enum TVCardSide)cardSide isEnablePhotoGalleryPicker:(BOOL)isEnablePhotoGalleryPicker OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) TVCardType * _Null_unspecified cardType;
@property (nonatomic) BOOL doReadBothSide;
@property (nonatomic) enum TVCardSide cardSide;
...
typedef SWIFT_ENUM(NSInteger, ActionMode, closed) {
  ActionModeSelfieCapturing = 0,
  ActionModeIdCapturing = 1,
};
...
@property (nonatomic) BOOL isSoundEnable;
@property (nonatomic) enum TVLivenessOption livenessMode;
- (nonnull instancetype)initWithCameraOption:(enum TVCameraOption)cameraOption isSoundEnable:(BOOL)isSoundEnable livenessMode:(enum TVLivenessOption)livenessMode OBJC_DESIGNATED_INITIALIZER;
...
+ (UINavigationController * _Nonnull)startIdCapturingWithLanguageCode:(NSString * _Nullable)languageCode configuration:(TVIdCardConfiguration * _Nonnull)configuration success:(void (^ _Nonnull)(TVDetectionResult * _Nonnull))success failure:(void (^ _Nonnull)(TVError * _Nonnull))failure cancellation:(void (^ _Nonnull)(void))cancellation SWIFT_WARN_UNUSED_RESULT;
